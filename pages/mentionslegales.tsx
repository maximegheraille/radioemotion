...
const mentionslegales = () => {
  return (
    <>
      <NextSeo
        canonical="https://www.radioemotion.be/mentionslegales"
        title="Mentions Legales"
        description="Les Mentions Legales"
        openGraph={{
          url: "https://www.radioemotion.be/mentionslegales",
          title: "Mentions Legales",
          description: "Les Mentions Legales",
          images: [
            {
      ...
      <div className="flex flex-col dark:text-white text-center py-16">
        ...
        <br />
        <p className="">
          Les informations détaillées au sujet du service Emotion et de
          l’éditeur Queen ASBL sont consultables sur le site du Conseil
